...
// NB: v_speed is float to allow adjusting the drag speed_ with more precision
...
static void ImGui::TabBarLayout(ImGuiTabBar* tab_bar)
{
    ...
    {
        // Scrolling speed_ adjust itself so we can always reach our target in 1/3 seconds.
